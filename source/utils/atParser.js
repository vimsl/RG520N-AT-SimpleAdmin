const AT_CMD_SIM = 'AT+QSIMSTAT?;+CSQ;+QTEMP;+QUIMSLOT?;+QSPN;+CGCONTRDP=1;+QMAP="WWANIP"';
const AT_CMD_RADIO = 'AT+QENG="servingcell";+QNWINFO;+QRSRP;+QNWCFG="nr5g_ambr";+QNWCFG="up/down"';
...
export function getAtCommands() { return [AT_CMD_SIM, AT_CMD_RADIO]; }
export function getAtCommand() { return AT_CMD_SIM + ';' + AT_CMD_RADIO; }
